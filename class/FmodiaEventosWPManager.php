...
class FmodiaEventosWPManager
{
    ...
    public static function registerFrontendAssets()
    {
        ...
        $homeJs = FMODIAEVENTOSWP_PLUGIN_DIR . 'js/home.js';
        ...
        wp_register_script(
            'fmodia-eventos-home',
            FMODIAEVENTOSWP_PLUGIN_URL . 'js/home.js',
            [],
            file_exists($homeJs) ? filemtime($homeJs) : FMODIAEVENTOSWP_VERSION,
            true
        );
    }
